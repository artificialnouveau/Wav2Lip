...
- for /F %i in (requirements.txt) do pip install %i || echo Failed to install %i, continuing...
- pip install opencv_python-4.4.0-cp36-cp36m-win_amd64.whl (download from https://www.lfd.uci.edu/~gohlke/pythonlibs/)
